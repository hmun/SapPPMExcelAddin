...
Public Class TSAP_GetTsIdsData
    ...
    Public Function valid_Data_Field(pTStrRec As SAPCommon.TStrRec) As Boolean
        ...
        If pTStrRec.Strucname = "IT_ZPPM_S_TS_IDS" Or pTStrRec.Strucname = "IDS" Then
            valid_Data_Field = isInArray(pTStrRec.Fieldname, Ids_Fields)
        End If
    End Function
