...
Public Class TSAP_PostTSData

    Public aHdrRec As TDataRec
    Public aData As TData
    Public aExt As TData

    Private Hd_Fields() As String = {""}
    Private CAT_Fields() As String = {"IDENTIFIER, UPDATE_DATE, TASK_NUMBER, SAP_OBJECT, HYPERION_CODE, EMAIL, START_DATE, CALENDER_WEEK, STATUS, MINUTES_SUNDAY, MINUTES_MONDAY, MINUTES_TUESDAY, MINUTES_WEDNESDAY, MINUTES_THURSDAY, MINUTES_FRIDAY, MINUTES_SATURDAY, NOTES_SUNDAY, NOTES_MONDAY, NOTES_TUESDAY, NOTES_WEDNESDAY, NOTES_THURSDAY, NOTES_FRIDAY, NOTES_SATURDAY"}

    Private aPar As SAPCommon.TStr
    Private aIntPar As SAPCommon.TStr
    Private Shared ReadOnly log As log4net.ILog = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType)

    Private Const sCAT As String = "IT_CATS"
    ...
    Public Function valid_Data_Field(pTStrRec As SAPCommon.TStrRec) As Boolean
        ...
        If pTStrRec.Strucname = "IT_CATS" Or pTStrRec.Strucname = "CAT" Then
            valid_Data_Field = isInArray(pTStrRec.Fieldname, CAT_Fields)
        End If
    End Function
