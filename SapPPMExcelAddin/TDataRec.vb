...
Public Class TDataRec
    ...
    Public Function name2Fieldname(pNAME As String) As String
        Dim aNameArray() As String
        Dim aSTRUCNAME As String = ""
        Dim aFIELDNAME As String = ""
        If InStr(pNAME, "-") <> 0 Then
        ...
        Else
            ...
            aFIELDNAME = pNAME
        End If
        name2Fieldname = aFIELDNAME
    End Function

    Public Function name2Strucname(pNAME As String) As String
        Dim aNameArray() As String
        Dim aSTRUCNAME As String = ""
        Dim aFIELDNAME As String = ""
        If InStr(pNAME, "-") <> 0 Then
