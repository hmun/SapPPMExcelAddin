...
Partial Public NotInheritable Class SapPPMExcelAddIn
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _SapPPMExcelAddIn As SapPPMExcelAddIn
    ...
    Friend Shared Property SapPPMExcelAddIn() As SapPPMExcelAddIn
        Get
            Return _SapPPMExcelAddIn
        End Get
        Set
            If (_SapPPMExcelAddIn Is Nothing) Then
                _SapPPMExcelAddIn = value
            Else
